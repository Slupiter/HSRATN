...
if __name__ == '__main__':
    ...
    parser.add_argument('--arch', default='tsrn', choices=['tsrn','tsr','ipt','msrn','msrnRe','hran','hranRe','hranSeries','hranSeriesLaplace','drln','rcan', 'bicubic', 'srcnn', 'vdsr', 'srres', 'esrgan', 'rdn',
                                                           'edsr', 'lapsrn'])
